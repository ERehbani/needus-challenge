...
const Description = () => {
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
      ...
      <TabsContent value="description" className="mt-4 h-48 max-md:h-60 overflow-y-auto">
      ...
      <TabsContent value="specification" className="h-48 max-md:h-60 overflow-y-auto">
        <Card className=" border-none shadow-none">
          <CardContent className="p-6">
      ...
      <TabsContent value="reviews" className="h-48 max-md:h-60 overflow-y-auto">
        <Card className=" border-none shadow-none">
          <CardContent className="p-6">
